...
_C.USE_TRAIN_COPY=0
_C.ECCV=CN()
_C.ECCV.mask_self_similarity=False
_C.ECCV.init_way='uniform'#'xavier_uniform'
_C.green_counter=False
_C.IMPROMPT=CN()
_C.IMPROMPT.save_in_cpu=True
_C.IMPROMPT.save_oneshot_imprompts=True
_C.IMPROMPT.embed_via_dyhead=0#0,1
_C.IMPROMPT.map_module='conv'#'mlp'#'conv'
_C.IMPROMPT.train_one_image_repeatly=False
_C.IMPROMPT.embed_768_to_lang=2 #{0,1,2}
_C.IMPROMPT.train_gt_1_per_class=1 #{-1,0,1}
_C.IMPROMPT.embed_768_to_lang_adaptively=True
_C.IMPROMPT.gvl2=0
_C.IMPROMPT.gvl=0 #{-1,0,1,2}#MAIN SWITCH! 0 return to original GLIP; -1 the best experiment as in paper; 1/2 only for debug
_C.IMPROMPT.shot_num=2 #{1~30}
_C.IMPROMPT.shot_fusion='concat'#'average' #'concat','max','add' #how to combine shot-wise embeddings
_C.IMPROMPT.conv_scales_weight_sharing_=1 #{0,1}
_C.IMPROMPT.conv_scales_used=5 #{1,2,3,4,5} #how many scales of 5-scale object-detect feature will be used
_C.IMPROMPT.stage_num=[1,2,3,4,5,6,7,8] #subset of [1,2,3,4,5,6,7,8] #defines cross-att module stage numbers which will be mapped to text embedding 768-dim space
_C.IMPROMPT.stage_fusion='max'#'average' #'concat','max','add','residual' #how to combine different output 768-dim embeddings
_C.IMPROMPT.input_way='input_image_itself'#'first_gt_box'#'input_image_itself''real_gt'
_C.IMPROMPT.override_text_prompt=False#caution: Ablation Study Usage
_C.VIS_PRED_ONLY=0#only visualize prediction results when debuging, no need GT
_C.use_bitfit_cross=0
############the following 2 parameter control VISUALIZE format: bbox, mask,or contour
_C.mask2contour=True#mask,or contour
_C.MASK_ON_WHEN_TEST=True #bbox
_C.plot_tsne=0
_C.append_locinfo_when_inference=0
_C.print_flops=0
_C.print_params=0
_C.weight96=0
_C.use_upt=0
...
_C.lang_adap_mlp = 0
_C.VISUALIZE = False
_C.NEED_PREDJSON = True
_C.vl_cross_att = 0
_C.fuse_module_cross_att = 0
_C.USE_CAM=False#conflict with SOLVER.TEST_WITH_INFERENCE !!! wuyongjian: either inference( obtain APscores and plot) or obly_plot_cam. YOU CAN'T ORDER BOTH!
_C.NEED_LABELBOX=True
_C.NEED_2REALNAME=False
_C.THRE=0.5
_C.input_nucleus_prompt=0
_C.MAX_IMAGE_NUM_WHEN_USE_CAM=400
_C.PLOT_GTBOX=False
_C.vpt_only=0
...
_C.GT_MASK_ON=False
_C.eval_segm=1
_C.NO_JSON_FOR_DISK_SPACE=False
_C.MODEL = CN()
_C.MODEL.RPN_ONLY = False
_C.MODEL.RPN_NEED_RETURN_PROPOSALS=False
_C.MODEL.BOX_ON = False
...
#______________________________________________________________________________copy from vpt
...
_C.MODEL.DYHEAD.FUSE_CONFIG.SHALLOW_MAX_POSITIVE_ANCHORS = 1000
...
_C.MODEL.ROI_MASK_HEAD.FEATURE_EXTRACTOR = "HourglassFPNFeatureExtractor"
_C.MODEL.ROI_MASK_HEAD.PREDICTOR = "VLMaskRCNNC4Predictor"
_C.MODEL.ROI_MASK_HEAD.POOLER_RESOLUTION = 28
...
_C.MODEL.ROI_MASK_HEAD.NUM_CLASSES = 2
...
_C.MODEL.RESNETS.DCN_CONFIG = CN()
_C.MODEL.RESNETS.DCN_CONFIG.stage_with_dcn = (False, False, False, False)
