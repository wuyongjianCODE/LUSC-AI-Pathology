...
if __name__ == '__main__':
    ...
    NP = r'/data1/wyj/M/datasets/LUNG_NP/'
    NP_remained = r'/data1/wyj/M/datasets/LUNG_NPTEST/'
    ...
    if args.command == "train":
        MaskrcnnPath = 'resnet_lungNPresnet_15.h5'
        model.load_weights(os.path.abspath(MaskrcnnPath))
        for it in range(16,30):
            ...
            model.fit_generator(
                ...
                validation_data=validation_generator,
                validation_steps=10)
            model.save('resnet_lungNPresnet_{}.h5'.format(it))
    ...
    if args.command == "detect":
        MaskrcnnPath = 'resnet_lungNPresnet_C5_1.h5'
        model.load_weights(os.path.abspath(MaskrcnnPath))
        DETECT_SET=False
        if DETECT_SET:
            score = model.evaluate_generator(generator=validation_generator,
            ...
            print('%s: %.2f%%' % (model.metrics_names[1], score[1] * 100))  # metrics1
            print('%s: %.2f%%' % (model.metrics_names[2], score[2] * 100))  # metrics2
        SVSDIR='/data1/wyj/M/datasets/data2/svs1/'#'/data1/wyj/M/datasets/data2/svs3conv/'
        for svsname in os.listdir(SVSDIR):
            if '.svs' in svsname:
                ...
                plt.savefig('{}_whole_classify_resnet.png'.format(svsname[:-4]))
                plt.show()
        # orig_imgs=[]
