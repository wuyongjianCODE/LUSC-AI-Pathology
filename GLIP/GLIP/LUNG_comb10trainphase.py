...
def main():
    ...
    parser.add_argument("--geojson_dir", default="/home/data/jy/GLIP/DATASET/lungfinalV/",
                        help="Directory of GeoJSON files (lungfinalV dataset)")
    parser.add_argument("--image_dir", default="/home/data/jy/GLIP/DATASET/lungfinalV/原图",
                        help="Directory of original images (lungfinalV dataset)")
    parser.add_argument("--output_json", default="/home/data/jy/GLIP/DATASET/lungfinalV/out/coco_annotations.json",
                        help="Output path for COCO JSON (lungfinalV dataset)")
    parser.add_argument("--patch_dir", default="/home/data/jy/GLIP/DATASET/lungfinalV/out/patches",
                        help="Directory to save patches (lungfinalV dataset)")
    parser.add_argument("--vis_original_dir", default="/home/data/jy/GLIP/DATASET/lungfinalV/out/visualizations/original",
                        help="Directory to save original GT images (lungfinalV dataset)")
    parser.add_argument("--vis_patch_dir", default="/home/data/jy/GLIP/DATASET/lungfinalV/out/visualizations/patches",
                        help="Directory to save patch GT images (lungfinalV dataset)")
