...
if __name__ == '__main__':
    ...
    if args.command == "detect":
        itern=6
        savp='TOSHOW_MULTISCALE_beijingnew_{}'.format(itern)
        ...
        if DETECT_SET:
            ...
            print('%s: %.2f%%' % (model.metrics_names[1], score[1] * 100))  # metrics1
            print('%s: %.2f%%' % (model.metrics_names[2], score[2] * 100))  # metrics2
        SVSDIR =r'/data2/beijingnew/2-新辅助鳞癌术后LN评估-130例-359张-20240227_svs/'# r'/data3/kfb-new/'#r'/data3/SCC58/incomp-20/'#/data1/wyj/M/datasets/data2/svs1/'#'/data1/wyj/M/datasets/data2/svs3conv/'
