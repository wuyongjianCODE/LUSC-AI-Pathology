...
def vis(img, boxes, scores, cls_ids, conf=0.5, class_names=None,col=[255,255,255],linewidth=2):
    ...
    for i in range(len(boxes)):
        ...
        cv2.rectangle(img, (x0, y0), (x1, y1), col, linewidth)
