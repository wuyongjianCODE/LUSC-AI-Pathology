...
def print_self_training_COLORED_ALLSHOW_FINALMAP_major():
    fid = 0
    submits = [  # '/home/data/jy/GLIP/DATASET/coco1/val2017/',  # ori
        '/home/data/jy/GLIP/OUTPUT1/0.30437/',
        '/home/data/jy/GLIP/OUTPUT1/0.30456/',
        '/home/data/jy/GLIP/OUTPUT1/0.32269/',
        '/home/data/jy/GLIP/OUTPUT1/0.36927/',
        "/home/data/jy/GLIP/OUTPUT1/0.30131/",  # 1ssns 354
        "/home/data/jy/GLIP/COMP_OUTPUTS/0.2938111707351383/",  # 2 275
        "/home/data/jy/GLIP/COMP_OUTPUTS/0.27047253330669924/",  # 3  262
        "/home/data/jy/GLIP/OUTPUT1/0.25163/",  # 4 292
    ...
    for image_id in os.listdir(submits[1]):
        allpic = ["000000000186.jpg", "000000000027.jpg",
                  "000000000046.jpg", "000000000463.jpg", "000000000174.jpg", "000000000257.jpg", "000000000363.jpg",
                  "000000000203.jpg", "000000000234.jpg",
                  "000000000455.jpg", "000000000352.jpg", "000000000200.jpg", "000000000036.jpg", "000000000448.jpg",
                  "000000000180.jpg",
                  "000000000456.jpg", "000000000023.jpg", ]
        allpic = ["000000000257.jpg", "000000000463.jpg", "000000000180.jpg", "000000000023.jpg", ]
        SHORTID = 0
        ...
        INCH = 20
        fig = plt.gcf()
        fig.set_size_inches(2.6 * INCH, 1.4 * INCH)
        HAS_ = 0
    ...
    # plt.show()
    submits = [  # '/home/data/jy/GLIP/DATASET/coco1/val2017/',  # ori
        '/home/data/jy/GLIP/OUTPUT2/0.31042/',
        '/home/data/jy/GLIP/OUTPUT2/0.31867/',
        '/home/data/jy/GLIP/OUTPUT2/0.34427/',
        '/home/data/jy/GLIP/OUTPUT2/0.37471/',
        "/home/data/jy/GLIP/OUTPUT2/0.27752/",  # 1ssns 354
        "/home/data/jy/GLIP/OUTPUT2/0.22034/",  # 2 275
        "/home/data/jy/GLIP/OUTPUT2/0.15932/",  # 3  262
        "/home/data/jy/GLIP/OUTPUT2/0.23618/",  # 4 292
    ...
    for image_id in os.listdir(submits[1]):
        allpic = ["000000000053.jpg", "000000000023.jpg",
                  "000000000003.jpg", "000000000022.jpg", "000000000017.jpg", "000000000010.jpg", "000000000034.jpg",
                  "000000000021.jpg", "000000000030.jpg",
                  "000000000014.jpg", "000000000024.jpg"]
        allpic = ["000000000017.jpg", "000000000008.jpg",
                  "000000000025.jpg", "000000000044.jpg"]
        allpic2 = [
...
print_self_training_COLORED_ALLSHOW_FINALMAP_major()
