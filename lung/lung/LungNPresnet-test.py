...
if __name__ == '__main__':
    ...
    if args.command == "train":
        MaskrcnnPath = 'resnet_lungNPresnet_14.h5'
        model.load_weights(os.path.abspath(MaskrcnnPath), by_name=True)
    ...
    if args.command == "detect":
        ...
        if DETECT_SET:
            ...
            print('%s: %.2f%%' % (model.metrics_names[1], score[1] * 100))  # metrics1
            print('%s: %.2f%%' % (model.metrics_names[2], score[2] * 100))  # metrics2
        SVSDIR ='/data1/wyj/M/datasets/data2/svs1/'#'/data1/wyj/M/datasets/data2/svs3conv/'# '/home/iftwo/data1/pathology_label/2019005105/'#
        for svsname in os.listdir(SVSDIR):
            if '.svs' in svsname:
                ...
                plt.savefig('TOSHOW/{}_whole_classify_resnet.png'.format(svsname[:-4]))
                plt.show()
        # orig_imgs=[]
