...
def main():
    ...
    parser.add_argument("--train_label", default="DATASET/coco/annotations/instances_train2017_glipGT.json")
...
def prepare_for_CONSEP_GT_detection(phase='Train'):#wuyongjian: used for OUR CONSEP
    ...
    # pass
    with open('DATASET/coco2/annotations/instances_{}2017.json'.format(phase.lower()), "w") as f:
